...
- Над сеткой: общий средний GearScore; число и средний GS по ролям; сводка настой/еда с **Сообщить настой** / **Сообщить еду**; сводка gear check после скана
...
- **Сканировать** / **Экспорт**; **Экспорт** открывает текст; **К составу** закрывает его; **Выделить всё** + Ctrl+C для копирования
