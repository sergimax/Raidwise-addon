...
- Над сеткой: общий средний GearScore; число и средний GS по ролям; сводка gear check после скана
- Карточка: класс + имя, роль + спек + GS/iLvl, иконки рейд-баффов, строка мнения, оценки брони/чар, **Профиль** / **Экип** / **Перескан**
