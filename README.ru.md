...
- Во вкладке **События** выберите тип по категории (**Посещаемость**, **Лут**, **Помощь**, **Поведение**) и **Добавить событие** / **Удалить** (черновик до **Сохранить и обновить**; контекст зоны при добавлении)
