...
- **Сканировать** — поочерёдный осмотр группы/рейда; таблица с итогом, BAD, REPLACE и числом проблем
- Клик по строке открывает полный отчёт на вкладке **Проверка экипа (цель)** (без повторного скана)
