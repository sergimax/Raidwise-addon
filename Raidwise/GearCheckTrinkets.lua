...
local A_PHYS = Ids(P_PHYS, TR_WHISPERING_FANGED_SKULL, TR_DEATHS_VERDICT, TR_NEEDLE, TR_MIRROR, TR_MARK_SUPREMACY, TR_BANNER, TR_BLOOD_OLD_GOD, TR_MJOLNIR, TR_DARK_MATTER_ULDUAR, TR_PYRITE, TR_GRIM_TOLL, TR_COMET)

local P_RET = Ids(P_PHYS, TR_TINY_ABOM)
local A_RET = Ids(A_PHYS, TR_TINY_ABOM)

local P_HUNTER = Ids(TR_DBW, TR_SHARPENED)
local A_HUNTER = Ids(P_HUNTER, TR_WHISPERING_FANGED_SKULL, TR_DEATHS_VERDICT, TR_NEEDLE, TR_MIRROR, TR_MARK_SUPREMACY, TR_BANNER)
