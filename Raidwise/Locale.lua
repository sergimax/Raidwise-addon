...
local Translations = {
	enUS = {
		...
		GEAR_CHECK_LIMITATION = "Gear Check is a surface-level evaluation. It does not consider BiS lists, specific gear builds, encounter requirements, or detailed stat weights. Phase 5 dump shows overall status, meta activation, and set counts.",
		GEAR_CHECK_SCAN = "Scan",
		GEAR_CHECK_HINT = "Target a player (or clear target to scan yourself), then press Scan. Phase 5 dump lists overall status, verdicts, and findings. Run /rw gearcheck test for offline rule fixtures.",
	...
	ruRU = {
		...
		GEAR_CHECK_LIMITATION = "Gear Check — поверхностная оценка. Без BiS, билдов, энкаунтеров и весов статов. Фаза 5: overall, мета и сеты (информативно).",
		GEAR_CHECK_SCAN = "Сканировать",
		GEAR_CHECK_HINT = "Возьмите в цель игрока (или снимите цель, чтобы проверить себя) и нажмите «Сканировать». Фаза 5 — dump с overall и вердиктами. /rw gearcheck test — офлайн-фикстуры правил.",
