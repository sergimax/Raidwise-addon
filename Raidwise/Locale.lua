...
local Translations = {
	enUS = {
		TAB_SYNC = "Characters data import",
		TAB_SYNC_EXPORT = "Characters data export",
		TAB_REPUTATION = "Reputation",
		REPUTATION_LOCAL = "My local opinions",
		REPUTATION_RECEIVED = "Received opinions (read-only)",
		REPUTATION_GLOBAL = "Global Karma",
		REPUTATION_KARMA_EMPTY = "No Global Karma dataset installed.",
		REPUTATION_KARMA_INFO = "%s — revision %s, published %s",
		REPUTATION_KARMA_REVIEW = "Review Karma JSON",
		SYNC_DESCRIPTION = "Receive shared characters or paste JSON from the web app. Review changes before applying them.",
		SYNC_EXPORT_DESCRIPTION = "Export saved character profiles as JSON. Use a character Share menu to send directly to another Raidwise user.",
		SYNC_SEARCH = "Find a known character (refine name to narrow results)",
		SYNC_SELECT = "Select a character",
		SYNC_SELECTED = "Selected: %s",
		SYNC_TO_WHISPER = "To target",
		SYNC_TO_GUILD = "To guild",
		SYNC_TO_RAID = "To raid",
		SYNC_ALL_WHISPER = "All to target",
		SYNC_ALL_GUILD = "All to guild",
		SYNC_ALL_RAID = "All to raid",
		SYNC_SHARE = "Share",
		SYNC_SHARE_ALL = "Share database",
		SYNC_REQUESTS = "Incoming requests",
		SYNC_REQUEST_FROM = "%s offers %d characters. Open Import to receive or decline.",
		SYNC_NO_REQUEST = "No incoming requests.",
		SYNC_RECEIVE = "Receive",
		SYNC_DECLINE = "Cancel",
		SYNC_IGNORE = "Ignore",
		SYNC_UNIGNORE = "Unignore",
		SYNC_IGNORE_NAME = "Ignore / find character by name (all realms)",
		SYNC_IGNORED_LIST = "Ignored characters (%d)",
		SYNC_IGNORED_EMPTY = "No ignored characters match.",
		SYNC_IGNORED_PAGE = "%d–%d of %d",
		SYNC_PREVIOUS = "Previous",
		SYNC_NEXT = "Next",
		SYNC_DISABLE = "Disable incoming requests",
		SYNC_ENABLE = "Enable incoming requests",
		SYNC_STOP_SEND = "Stop sending",
		SYNC_STOP_RECEIVE = "Stop receiving",
		SYNC_JSON = "JSON to import",
		SYNC_EXPORT_ONE = "Export selected",
		SYNC_EXPORT_ALL = "Export database",
		SYNC_PREVIEW = "Review JSON",
		SYNC_REVIEW = "Incoming changes (local profiles are protected)",
		SYNC_APPLY = "Apply changes",
		SYNC_PRIVACY = "Private memos, encounters and local Main choices are never shared. Existing character groups are kept.",
		SYNC_INVALID = "Invalid or oversized exchange data. Nothing imported.",
		SYNC_VERSION = "Unsupported report version. Nothing imported.",
		SYNC_LIMIT = "Exchange limit: 1,000 characters, 256 KiB, 100 events/links per character. Share smaller selections.",
		SYNC_EMPTY = "No saved character profiles to share.",
		SYNC_BUSY = "An exchange or review is active. Finish or cancel it first.",
		SYNC_TARGET_REQUIRED = "Target another player to share with them.",
		SYNC_RAID_REQUIRED = "Join a raid before sharing to raid.",
		SYNC_GUILD_REQUIRED = "Join a guild before sharing to guild.",
		SYNC_SEND_FAILED = "Could not send the exchange. Please retry.",
		SYNC_OFFER_SENT = "Request sent. Waiting for recipients with Raidwise to accept (30 minutes).",
		SYNC_CANCELLED = "Transfer cancelled or sender busy. You can request another share.",
		SYNC_EXPIRED = "Request or transfer expired. Ask the sender to share again.",
		SYNC_RECEIVING = "Receiving data. No changes are applied until you review and accept.",
		SYNC_SENDING = "Sending accepted transfer…",
		SYNC_SENT = "Transfer sent. The recipient must review and apply it.",
		SYNC_READY = "Data received. Review incoming changes in Import before applying.",
		SYNC_NO_REVIEW = "No pending changes. Receive a request or paste JSON and select Review JSON.",
		...
		TAB_EXPORT = "My gear and CDs exports",
		...
		MENU_GROUP_EXPORT_WEB = "Export to web",
		MENU_GROUP_EXCHANGE = "Data exchange",
		...
		BTN_RAID_MEMBER_WEAPON_REPORT_TIP = "Report this player's weapon issues to the report chat channel (title bar).",
		BTN_RAID_MEMBER_ARMOR_REPORT_TIP = "Report this player's armor issues to the report chat channel (title bar).",
		BTN_RAID_MEMBER_GEMS_REPORT_TIP = "Report this player's gem issues to the report chat channel (title bar).",
		BTN_RAID_MEMBER_ENCHANTS_REPORT_TIP = "Report this player's enchant issues to the report chat channel (title bar).",
		...
		DATABASE_ADD = "Add character",
		DATABASE_ACTIONS = "Actions",
		DATABASE_DELETE = "Delete",
		DATABASE_DELETE_ALL = "Delete all",
		DATABASE_DELETE_CONFIRM = "Delete %s from Character database?\nThis cannot be undone.",
		DATABASE_DELETE_ALL_CONFIRM = "Delete all %d Character database records?\nThis cannot be undone.",
		DATABASE_INVALID_NAME = "Enter a character name without spaces or chat markup.",
		FILTER_OPINION_ALL = "Opinion: all",
		FILTER_SOURCE_ALL = "Source: all",
		HISTORY_FILTERS = "Filters",
		HISTORY_ENTRY_COUNT = "Entries: %d",
		...
		GEAR_CHECK_TARGET_COMBAT = "Leave combat before selecting or inspecting this character.",
		...
		CHAR_ROLE_ALT = "Alt",
		CHAR_LINK_ADD = "Link",
		CHAR_LINK_REMOVE = "Unlink",
		CHAR_LINK_TARGET = "Link target",
		CHAR_LINK_SEARCH = "Find a character in History:",
		CHAR_LINK_HINT = "Main is local only, never exchanged. Alt links identify one player for exchange. Opinion is shared. Auto-saved.",
		CHAR_LINK_SAVED = "Character links saved.",
		CHAR_LINK_INVALID = "Select a known character to link.",
		CHAR_LINK_SELF = "This is the same character.",
		CHAR_LINK_EXISTS = "These characters are already linked.",
		CHAR_LINK_OTHER_GROUP = "Unlink this character from its current player group first.",
		CHAR_LINK_MAIN_REQUIRED = "Choose another main before unlinking or demoting this character.",
		CHAR_LINK_TARGET_MISSING = "Target a player character first.",
		CHAR_LINK_CONFLICT = "Opinions differ. Choose the opinion to share before linking:",
		CHAR_LINK_KEEP = "Use %s",
		CHAR_LINK_CANCEL = "Cancel",
		CHAR_LINK_TOOLTIP = "Same player (local links):",
		CHAR_LINK_TOOLTIP_ROW = "%s — %s",
		CHAR_LINK_HISTORY_ADD = "Linked character: %s",
		CHAR_LINK_HISTORY_REMOVE = "Unlinked character: %s",
		CHAR_LINK_HISTORY_ROLE = "%s is now %s",
	...
	ruRU = {
		TAB_SYNC = "Импорт данных персонажей",
		TAB_SYNC_EXPORT = "Экспорт данных персонажей",
		TAB_REPUTATION = "Репутация",
		REPUTATION_LOCAL = "Мои локальные мнения",
		REPUTATION_RECEIVED = "Полученные мнения (только чтение)",
		REPUTATION_GLOBAL = "Глобальная Karma",
		REPUTATION_KARMA_EMPTY = "Глобальная база Karma не установлена.",
		REPUTATION_KARMA_INFO = "%s — ревизия %s, опубликовано %s",
		REPUTATION_KARMA_REVIEW = "Проверить JSON Karma",
		SYNC_DESCRIPTION = "Получайте общих персонажей или вставляйте JSON из веб-приложения. Проверьте изменения перед применением.",
		SYNC_EXPORT_DESCRIPTION = "Экспортируйте сохранённые профили персонажей в JSON. Для прямой отправки другому пользователю Raidwise используйте меню «Поделиться» персонажа.",
		SYNC_SEARCH = "Поиск известного персонажа (уточните имя)",
		SYNC_SELECT = "Выберите персонажа",
		SYNC_SELECTED = "Выбран: %s",
		SYNC_TO_WHISPER = "Цели",
		SYNC_TO_GUILD = "Гильдии",
		SYNC_TO_RAID = "Рейду",
		SYNC_ALL_WHISPER = "Все — цели",
		SYNC_ALL_GUILD = "Все — гильдии",
		SYNC_ALL_RAID = "Все — рейду",
		SYNC_SHARE = "Поделиться",
		SYNC_SHARE_ALL = "Отправить базу",
		SYNC_REQUESTS = "Входящие запросы",
		SYNC_REQUEST_FROM = "%s предлагает %d персонажей. Откройте Импорт, чтобы получить или отклонить.",
		SYNC_NO_REQUEST = "Нет входящих запросов.",
		SYNC_RECEIVE = "Получить",
		SYNC_DECLINE = "Отмена",
		SYNC_IGNORE = "Игнор",
		SYNC_UNIGNORE = "Разрешить",
		SYNC_IGNORE_NAME = "Игнор / поиск персонажа по имени (все серверы)",
		SYNC_IGNORED_LIST = "Игнорируемые персонажи (%d)",
		SYNC_IGNORED_EMPTY = "Совпадений в списке игнора нет.",
		SYNC_IGNORED_PAGE = "%d–%d из %d",
		SYNC_PREVIOUS = "Назад",
		SYNC_NEXT = "Далее",
		SYNC_DISABLE = "Отключить входящие запросы",
		SYNC_ENABLE = "Включить входящие запросы",
		SYNC_STOP_SEND = "Стоп отправки",
		SYNC_STOP_RECEIVE = "Стоп получения",
		SYNC_JSON = "JSON для импорта",
		SYNC_EXPORT_ONE = "Экспорт одного",
		SYNC_EXPORT_ALL = "Экспорт базы",
		SYNC_PREVIEW = "Проверить JSON",
		SYNC_REVIEW = "Изменения (локальные профили защищены)",
		SYNC_APPLY = "Применить",
		SYNC_PRIVACY = "Личные заметки, встречи и выбор основного персонажа не передаются. Существующие группы сохраняются.",
		SYNC_INVALID = "Неверные данные обмена или превышен размер. Импорт не выполнен.",
		SYNC_VERSION = "Версия отчёта не поддерживается. Импорт не выполнен.",
		SYNC_LIMIT = "Лимит: 1000 персонажей, 256 КиБ, 100 событий/связей на персонажа. Уменьшите выборку.",
		SYNC_EMPTY = "Нет сохранённых профилей для отправки.",
		SYNC_BUSY = "Обмен или просмотр уже открыт. Завершите или отмените его.",
		SYNC_TARGET_REQUIRED = "Выберите другого игрока целью для отправки.",
		SYNC_RAID_REQUIRED = "Для отправки рейду нужно быть в рейде.",
		SYNC_GUILD_REQUIRED = "Для отправки гильдии нужно состоять в гильдии.",
		SYNC_SEND_FAILED = "Не удалось отправить данные. Повторите попытку.",
		SYNC_OFFER_SENT = "Запрос отправлен. Ожидание согласия игроков с Raidwise (30 минут).",
		SYNC_CANCELLED = "Передача отменена или отправитель занят. Можно запросить обмен снова.",
		SYNC_EXPIRED = "Истекло время запроса или передачи. Попросите отправить снова.",
		SYNC_RECEIVING = "Получение данных. Изменения применяются только после проверки и согласия.",
		SYNC_SENDING = "Отправка принятой передачи…",
		SYNC_SENT = "Данные отправлены. Получатель должен проверить и применить их.",
		SYNC_READY = "Данные получены. Проверьте изменения в Импорте перед применением.",
		SYNC_NO_REVIEW = "Нет изменений. Получите передачу или вставьте JSON и нажмите «Проверить JSON».",
		...
		TAB_EXPORT = "Мой экспорт экипировки и КД",
		...
		MENU_GROUP_EXPORT_WEB = "Экспорт в веб-приложение",
		MENU_GROUP_EXCHANGE = "Обмен данными",
		...
		BTN_RAID_MEMBER_WEAPON_REPORT_TIP = "Сообщить о проблемах оружия этого игрока в канал отчётов (Настройки).",
		BTN_RAID_MEMBER_ARMOR_REPORT_TIP = "Сообщить о проблемах брони этого игрока в канал отчётов (Настройки).",
		BTN_RAID_MEMBER_GEMS_REPORT_TIP = "Сообщить о проблемах камней этого игрока в канал отчётов (Настройки).",
		BTN_RAID_MEMBER_ENCHANTS_REPORT_TIP = "Сообщить о проблемах чар этого игрока в канал отчётов (Настройки).",
		...
		DATABASE_ADD = "Добавить персонажа",
		DATABASE_ACTIONS = "Действия",
		DATABASE_DELETE = "Удалить",
		DATABASE_DELETE_ALL = "Удалить всё",
		DATABASE_DELETE_CONFIRM = "Удалить %s из базы персонажей?\nДействие нельзя отменить.",
		DATABASE_DELETE_ALL_CONFIRM = "Удалить все %d записей базы персонажей?\nДействие нельзя отменить.",
		DATABASE_INVALID_NAME = "Введите имя персонажа без пробелов и разметки чата.",
		FILTER_OPINION_ALL = "Мнение: все",
		FILTER_SOURCE_ALL = "Источник: все",
		HISTORY_FILTERS = "Фильтры",
		HISTORY_ENTRY_COUNT = "Записей: %d",
		HISTORY_PAGE = "Страница %d/%d",
		HISTORY_PREVIOUS = "Назад",
		HISTORY_NEXT = "Далее",
		...
		GEAR_CHECK_TARGET_COMBAT = "Выйдите из боя перед выбором или осмотром персонажа.",
		...
		PROFILE_TAB_CHARACTERS = "Персонажи",
		CHAR_ROLE_MAIN = "Мейн",
		CHAR_ROLE_ALT = "Альт",
		CHAR_LINK_ADD = "Связать",
		CHAR_LINK_REMOVE = "Отвязать",
		CHAR_LINK_TARGET = "Связать цель",
		CHAR_LINK_SEARCH = "Найти персонажа в истории:",
		CHAR_LINK_HINT = "Мейн — локальный, не передаётся. Для обмена: альты — один игрок. Мнение общее. Сохраняется сразу.",
		CHAR_LINK_SAVED = "Связи персонажей сохранены.",
		CHAR_LINK_INVALID = "Выберите известного персонажа для связи.",
		CHAR_LINK_SELF = "Это тот же персонаж.",
		CHAR_LINK_EXISTS = "Эти персонажи уже связаны.",
		CHAR_LINK_OTHER_GROUP = "Сначала отвяжите персонажа от его текущей группы.",
		CHAR_LINK_MAIN_REQUIRED = "Сначала назначьте другого мейна.",
		CHAR_LINK_TARGET_MISSING = "Сначала выберите персонажа игрока в цель.",
		CHAR_LINK_CONFLICT = "Мнения различаются. Выберите общее мнение перед связыванием:",
		CHAR_LINK_KEEP = "Выбрать: %s",
		CHAR_LINK_CANCEL = "Отмена",
		CHAR_LINK_TOOLTIP = "Один игрок (локальные связи):",
		CHAR_LINK_TOOLTIP_ROW = "%s — %s",
		CHAR_LINK_HISTORY_ADD = "Связан персонаж: %s",
		CHAR_LINK_HISTORY_REMOVE = "Отвязан персонаж: %s",
		CHAR_LINK_HISTORY_ROLE = "%s теперь %s",
