...
local Translations = {
	enUS = {
		...
		CHAR_LINK_HINT = "One main, multiple alts. Opinion is shared. Changes save immediately. Choose another main before unlinking the current main.",
	...
	ruRU = {
		...
		CHAR_LINK_HINT = "Один мейн, несколько альтов. Мнение общее. Изменения сохраняются сразу. Перед отвязкой мейна выберите другого.",
