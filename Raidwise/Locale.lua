...
local Translations = {
	enUS = {
		...
		PROFILE_NOTES = "Notes",
		PROFILE_OPINION = "Personal opinion: %s",
		PROFILE_MET = "Met: %s",
		PROFILE_WHEN = "When: %s",
		PROFILE_REALM = "Realm: %s",
		PROFILE_GUID = "GUID: %s",
		RATING_PERSONAL_TITLE = "Personal rating",
		RATING_PERSONAL_OPINION_TITLE = "Personal opinion",
		RATING_TAGS_TITLE = "Personal tags",
		RATING_PROFILE_OPINION = "Personal opinion: %s",
		...
		RATING_COMMUNITY_TITLE = "Community opinion",
	...
	ruRU = {
		...
		RATING_COMMUNITY_TITLE = "Мнение сообщества",
