...
local Translations = {
	enUS = {
		...
		SYNC_DESCRIPTION = "Share saved characters with addon users, or exchange JSON with the web app. Receive first, review changes, then apply.",
		...
		SYNC_REQUEST_FROM = "%s offers %d characters. Open Synchronization to receive or decline.",
		...
		SYNC_JSON = "JSON: copy export or paste import",
		...
		SYNC_READY = "Data received. Review incoming changes in Synchronization before applying.",
	...
	ruRU = {
		...
		SYNC_DESCRIPTION = "Обмен персонажами с игроками с аддоном или через JSON с веб-приложением. Получите данные, проверьте изменения и примените.",
		...
		SYNC_REQUEST_FROM = "%s предлагает %d персонажей. Откройте Синхронизацию, чтобы получить или отклонить.",
		...
		SYNC_JSON = "JSON: скопируйте экспорт или вставьте импорт",
		...
		SYNC_READY = "Данные получены. Проверьте изменения в Синхронизации перед применением.",
