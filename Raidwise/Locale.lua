...
local Translations = {
	enUS = {
		...
		SETTINGS_STARTUP_TAB_HINT = "Which left-menu page opens when you launch Raidwise (/raidwise).",
	...
	ruRU = {
		...
		SETTINGS_STARTUP_TAB_HINT = "Какая вкладка левого меню открывается при запуске Raidwise (/raidwise).",
