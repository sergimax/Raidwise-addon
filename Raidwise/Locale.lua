...
local Translations = {
	enUS = {
		...
		GEAR_CHECK_RAID_EXPORT_TIP = "Open full text dumps for all scanned players (copy with Select all on Gear check target).",
	...
	ruRU = {
		...
		GEAR_CHECK_RAID_EXPORT_TIP = "Открыть полные текстовые отчёты по всем отсканированным игрокам (копирование — «Выделить всё» на вкладке проверки цели).",
