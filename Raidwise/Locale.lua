...
local Translations = {
	enUS = {
		...
		GEAR_CHECK_SAVED_DELETE = "Delete saved",
		...
		GEAR_CHECK_STATUS_SAVED = "Viewing saved report: %s",
		...
		GEAR_CHECK_STATUS_TIMEOUT = "Inspect timed out — results may be incomplete. Move closer and Scan again.",
	...
	ruRU = {
		...
		GEAR_CHECK_SAVED_DELETE = "Удалить",
		...
		GEAR_CHECK_STATUS_SAVED = "Просмотр сохранённого отчёта: %s",
		...
		GEAR_CHECK_STATUS_TIMEOUT = "Осмотр не успел — результат может быть неполным. Подойдите ближе и сканируйте снова.",
