...
local Translations = {
	enUS = {
		...
		GEAR_CHECK_RAID_DESC = "Scan everyone in your party or raid. Click a row to open the full report on Gear check (target). Surface-level PvE evaluation only — same limits as single-target scan.",
		...
		GEAR_CHECK_RAID_COL_OVERALL = "Overall",
		GEAR_CHECK_RAID_COL_BAD = "BAD",
		GEAR_CHECK_RAID_COL_REPLACE = "Repl.",
		GEAR_CHECK_RAID_COL_ISSUES = "Issues",
	...
	ruRU = {
		...
		GEAR_CHECK_RAID_DESC = "Сканирование группы или рейда. Клик по строке открывает полный отчёт на вкладке «Проверка экипа (цель)». Поверхностная PvE-оценка — те же ограничения, что и для одной цели.",
		...
		GEAR_CHECK_RAID_COL_OVERALL = "Итог",
		GEAR_CHECK_RAID_COL_BAD = "BAD",
		GEAR_CHECK_RAID_COL_REPLACE = "Repl.",
		GEAR_CHECK_RAID_COL_ISSUES = "Проблемы",
		GEAR_CHECK_RAID_ROW_FAIL = "—",
