...
- Lines above the grid: four-column header (grade legend, GS averages, flask/food/armor/ench with note icons, Scan/Export all/Refresh/Back to roster); then scan status and progress
