...
| Element | Size | Notes |
|---------|------|-------|
| Top summary | full width | Missing classes + Roles above the masonry |
| Class icon | **20** px | Gap **6** px; all 10 classes on one row |
| Role chip | icon **16** + count, width ~**44** | Gap **6** px; horizontal |
