...
| Settings | `LAYOUT_VERSION = 3` | `PageSettings.lua` | Shell title bar (next to page name) |
...
| Startup page | Grid of left-menu page buttons; selected page opens on `/raidwise`. Stored in `RaidwiseDB.startupTab` (default `cooldowns`). |
