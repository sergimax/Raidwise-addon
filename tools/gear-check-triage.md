...
- Offline validation: `python scripts/test-gear-check.py [directory containing lupa]` uses Lupa's Lua 5.1 runtime to run the existing rule suite and collector/cache/meta regressions. No game API extensions or runtime addon dependencies were added.
