...
### Changed
- Raid-wide gear scans and roster grade summaries include groups 1–5 only. Reserve groups 6–8 retain manual Rescan and individual reports.
- Raid composition analyzes groups 1–5 only, excluding reserve groups 6–8 from counts, coverage and reports.
