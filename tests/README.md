...
| Profile JSON exchange, consent/transport, imports and privacy | `sync.test.mts`; Sync controls/anchors in `architecture.test.mts`; Classic text inputs in `theme.test.mts` |
